...
DM_N ADD_1N_N(DM_N n1){
	...
	if(temp.a[temp.n - 1] != 9){ 	//Если последняя цифра числа не равна 9, то прибавляем к ней единицу
		...
		if(counter == temp.n){ 		//Если число состоит из цифр 9, то увеличиваем размер массива на 1, присваиваем цифре в старшем разряде 1, а всем остальным цифрам присваиваем значение 0
