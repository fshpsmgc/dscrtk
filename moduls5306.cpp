...
//======
//Назначение:
//Умножение натурального числа на цифру (DM_N * int)
//
//Возвращаемое значение:
//Возвращение через аргумент
//
//Параметры:
//Измененяемое число
//Число, на которое умножают

void MUL_ND_N(DM_N &obj, unsigned int i)
{
	obj = obj * i;
}
...
//======
//Назначение:
//Умножение натурального числа на цифру (DM_N * DM_N)
//
//Возвращаемое значение:
//Натуральное число
//
...
//======
//Назначение:
//Вычитание из натурального числа другого числа помноженного на число, для неотрицательного результата
//
//Возвращаемое значение:
//Натуральное число
//
...
//Чилсо №1
//Число №2
//Число, на которое умножают число №2

DM_N SUB_NDN_N(DM_N n1, DM_N n2, unsigned k)
{
	DM_N sub;
	sub = n2 * k;
	if (COM_NN_D(n1, sub) != 1)
		return n1 - sub;
	else
		return 0;
}
